...
#include "../mbed-client-coap/source/include/sn_grs.h"
                                            ...
                                            sn_nsdl_capab_e /*nsdl_capab*/)
{
    ...
    //@TODO uint8_t msg_code = COAP_MSG_CODE_EMPTY;
        ...
        if (nsdl_coap_data->address.addr_ptr) {
            ...
            if ((received_coap_header->payload_len > 0) &&
                ...
                if(temp_ptr) {
                    ...
                    //@TODO msg_code = COAP_MSG_CODE_RESPONSE_REQUEST_ENTITY_TOO_LARGE;
...
bool M2MNsdlInterface::validate_security_object()
{
    ...
    for ( ; it != instances.end(); it++ ) {
        ...
        // @TODO uint32_t is_bs_server = _security->resource_value_int(M2MSecurity::BootstrapServer, instance_id);
