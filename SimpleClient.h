...
#ifndef EXAMPLES_LWM2M_PORT_SIMPLECLIENT_H_
#define EXAMPLES_LWM2M_PORT_SIMPLECLIENT_H_
...
public:
    ...
    ~MbedClient() {
        ...
        if(_register_security){
        	...
        	_register_security->delete_instance();
        }
    }
...
#endif /* EXAMPLES_LWM2M_PORT_SIMPLECLIENT_H_ */
